...
:Clone
%sh%  -lc "if [[ -d ~/aria2 ]]; then cd aria2; git pull; else git clone https://github.com/QQ2017/aria2-build-msys2.git aria2; cd aria2; git pull; fi" 2>&1 | busybox tee -a clone.log
